...
import { LottoRemarkComponent } from './lotto-remark/lotto-remark.component';
...
@Component({
  selector: 'app-lotto-government',
  templateUrl: './lotto-government.component.html',
  styleUrls: ['./lotto-government.component.scss']
})
export class LottoGovernmentComponent implements OnInit {
  ...
  getLottoClass() {
    this.httpBean.doGet(URL.LOTTO_CLASS + '/' + LottoConstants.LOTTO_GOVERNMENT).subscribe(res => {
  ...
  onCreatGroup() {
    this.router.navigate(['lotto-settings/lotto-government/lotto-government-add'],
      { queryParams: { category: LottoConstants.LOTTO_GOVERNMENT } }
    );
  }
  ...
  editData(data) {
    this.router.navigate(['lotto-settings/lotto-government/lotto-government-add'],
      { queryParams: { lottoClassCode: data.lottoClassCode, category: LottoConstants.LOTTO_GOVERNMENT } });
  }

  editLimitNumber(data) {
    this.router.navigate(['lotto-settings/lotto-government/limit-number'],
      { queryParams: { lottoClassCode: data.lottoClassCode, lottoClassName: data.className, category: LottoConstants.LOTTO_GOVERNMENT } });
  }
  ...
  getCount() {
    this.httpBean.doGet('draft-lotto-class/get-count-init/' + LottoConstants.LOTTO_GOVERNMENT)
      .subscribe((res) => {
  ...
  getLottoGroup(data) {
    ...
    this.router.navigate(['lotto-settings/lotto-government/lotto-config'],
      { queryParams: { classCode: data.lottoClassCode, className: data.className, category: LottoConstants.LOTTO_GOVERNMENT } });
  }
