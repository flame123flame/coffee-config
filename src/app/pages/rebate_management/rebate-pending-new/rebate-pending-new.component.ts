...
const URL = {
  PAGINATE: 'rebate/pending-paginate',
  APPROVE_ALL: 'rebate/approve-rebate',
  APPROVE: 'rebate/approve-all-rebate',
  REJECT_ALL: 'rebate/reject-all-rebate',
  REJECT: 'rebate/reject-rebate',
  GET_VIP_LIST: 'groupLevel/getAllGroupLevel'
}
@Component({
  selector: 'app-rebate-pending-new',
  templateUrl: './rebate-pending-new.component.html',
  styleUrls: ['./rebate-pending-new.component.scss']
})
export class RebatePendingNewComponent implements OnInit {
  columns: any = [
    { header: 'Rebate Title', field: 'tb.rebate_title' },
      ...
      if (data.status == "SUCCESS") {
        ...
        this.data = data.data.data.map(ele => {
          return {
            ...
            'tb.rebate_code': ele.rebateCode,
            'tb.rebate_title': ele.rebateTitle,
            'tb.code': ele.code,
