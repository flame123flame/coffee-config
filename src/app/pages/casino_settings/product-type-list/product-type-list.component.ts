import { ProductMappingDialogComponent } from './../provider-setting/product-mapping-dialog/product-mapping-dialog.component';
...
export class ProductTypeListComponent implements OnInit {
 ...
 onClickToMapping(data) {
   ...
   const dialogRef = this.dialog.open(ProductMappingDialogComponent, { data: data, width: 'auto' });
   dialogRef.afterClosed().subscribe(result => {
   });
