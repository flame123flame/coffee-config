import { GroupMappingProviderDialogComponent } from './group-mapping-provider-dialog/group-mapping-provider-dialog.component';
...
import { ProviderAddDialogComponent } from './provider-add-dialog/provider-add-dialog.component';
...
const URL = {
  GET_ALL_PROVIDER: "game-provider/get-all-provider",
