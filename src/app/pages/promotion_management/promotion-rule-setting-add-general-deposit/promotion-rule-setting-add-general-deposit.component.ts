...
interface RuleSetting {
  ...
  singleBonusLimconditionTypeit?: any;
  maxApprovalLimsingleBonusLimitit: number;
  maxApprovalLimitTymaxApprovalLimitpe: number;
  maxBonusLimmaxApprovalLimitTypeit: number;
  depositAmaxBonusLimitmt?: any;
  receiveBonusWalldepositAmtet?: any;
  bonusCalculatireceiveBonusWalleton: number;
  withdrawConditibonusCalculationon: number;
  conditionRemovwithdrawConditional?: any;
  bonusRecycconditionRemovalle?: any;
  productTybonusRecyclepe?: any;
  createdproductTypeBy: string;
  createdDacreatedByte: Date;
  updatedcreatedDateBy?: any;
  updatedDaupdatedByte?: any;
  maxBonusLimitTyupdatedDatepe?: any;
...
export interface depositLevelData {
  depositAmount: number;
  bonusRatio: number;
  multiplier: number;
}
...
@Component({
  selector: 'app-promotion-rule-setting-add-general-deposit',
  templateUrl: './promotion-rule-setting-add-general-deposit.component.html',
  styleUrls: ['./promotion-rule-setting-add-general-deposit.component.scss'],
  providers: [ChecklistDatabase],
})
export class PromotionRuleSettingAddGeneralDepositComponent implements OnInit {
  operation = null;
  promoCode = null;
  constructor(
