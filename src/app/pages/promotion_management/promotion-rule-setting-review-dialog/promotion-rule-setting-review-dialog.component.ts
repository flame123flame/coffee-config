...
import { PrsShowSettingComponent } from '../promotion-rule-setting/dialog/prs-show-setting/prs-show-setting.component';
...
interface RuleSetting {
  ...
  bonusCalculate: number;
  multiplierCondition: number;
...
@Component({
  selector: 'app-promotion-rule-setting-review-dialog',
  templateUrl: './promotion-rule-setting-review-dialog.component.html',
  styleUrls: ['./promotion-rule-setting-review-dialog.component.scss'],
  providers: [ChecklistDatabase]
})
export class PromotionRuleSettingReviewDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<PrsShowSettingComponent>,
    @Inject(MAT_DIALOG_DATA) public data: ResData,
  ...
  getPromotionDetail(promoCode: string) {
